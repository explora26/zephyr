...
More information about the board can be found on the `Mini_STM32H750 website`_.
...
For more details please refer to `Mini_STM32H750 website`_.
...
Flashing an application to MiniSTM32H750
----------------------------------------
...
:zephyr_file:`boards/weact/mini_stm32h750/mini_stm32h750.dts`.

Testing shell over USB in the MiniSTM32H750
*******************************************
